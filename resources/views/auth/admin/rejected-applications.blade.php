            ...
            <div class="row no-gutters row-bordered row-border-light">
                <div class="col-md-3 pt-0">
                    <div class="list-group list-group-flush account-settings-links">
                        <a class="list-group-item list-group-item-action" href="/admin/applications">Bekleyen Başvurular</a>
                        <a class="list-group-item list-group-item-action" href="/admin/approved-applications">Onaylanmış Başvurular</a>
                        <a class="list-group-item list-group-item-action active" href="/admin/rejected-applications">Reddedilmiş Başvurular</a>
